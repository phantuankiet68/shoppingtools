const en = {
    ...
    adminEmail: {
        ...
        messages: {
            ...
            missingSenderName:
                'System sender name is missing. Please configure Email Settings first.',
            invalidSenderEmail:
    ...
    pageList: {
        ...
        createModal: {
            ...
            validation: {
                ...
                siteRequired: 'Please select website',
            },
            messages: {
    ...
    brands: {
        ...
        empty: {
            ...
            description:
                'Create your first brand in the form on the left or try adjusting your search query.',
        },
    ...
    products: {
        ...
        pleaseSelectAtLeastOneProductToDeactivate:
        ...
        deactivateConfirmMultiple:
            'Deactivate {count} selected products? This action cannot be undone.',
        filters: 'Filters',
    ...
    invoice: {
        ...
        thankYou:
            'Thank you for your business. Please ensure payment is completed within the agreed period.',
        invoiceQuestion:
            'If you have any questions regarding this invoice, feel free to contact our support team anytime.',
        needHelp: 'Need Help?',
        ...
        author: {
            ...
            steps: {
                ...
                generateToken: {
                    ...
                    warning:
                        'Use Page Access Token instead of User Access Token for automatic posting.',
    ...
    emailProvider: {
        ...
        disconnectConfirmMessage:
            'Disconnect Gmail account "{email}"? This action will remove the OAuth connection.',
        ...
        step7Note:
            'Paste these values into the Email Provider configuration and save your settings.',
    },
    emailSubscribers: {
    ...
    adminChat: {
        ...
        notFriend:
            'You are not friends with this user yet (chat is available only after acceptance).',
