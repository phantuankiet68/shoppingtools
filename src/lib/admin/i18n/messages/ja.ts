const ja = {
    ...
    pageList: {
        ...
        createModal: {
            ...
            validation: {
                ...
                siteRequired: 'ウェブサイトを選択してください',
            },
            messages: {
                createSuccess: 'ページを作成しました',
                createFailed: 'ページの作成に失敗しました',
            },
        },
    },
    builderAdd: {
    ...
    brands: {
        ...
        empty: {
            ...
            description:
                '左側のフォームで最初のブランドを作成するか、検索クエリを調整してください。',
        },
    ...
    products: {
        ...
        deactivateConfirmSingle:
            '「{name}」を非公開に設定してもよろしいですか？この操作は元に戻せません。',
        deactivateConfirmMultiple:
            '選択した{count}個の商品を非公開に設定してもよろしいですか？この操作は元に戻せません。',
        filters: '絞り込み',
        deactivate: '非公開',
        create: '新規作成',
        edit: '編集',
    ...
    inventory: {
        ...
        lowStock: {
            ...
            logs: {
                filterClicked:
                    'フィルターがクリックされました — フィルターパネルを実装してください',
                rowAction: 'アイテム操作:',
            },
            title: '在庫不足一覧',
    ...
    invoice: {
        ...
        invoiceQuestion:
            'この請求書についてご不明な点がございましたら、いつでもサポートチームまでお問い合わせください。',
        needHelp: 'ヘルプが必要ですか？',
        ...
        author: {
            ...
            steps: {
                ...
                generateToken: {
                    ...
                    warning:
                        '自動投稿にはUser Access TokenではなくPage Access Tokenを使用してください。',
                ...
                connectPage: {
                    ...
                    description:
                        'Facebook Page IDとPage Access Tokenを設定フォームへ入力して予約投稿を有効化します。',
    ...
    adminChat: {
        ...
        noFriendsDesc:
            '友達申請を送るには「追加」、申請を承認するには「リクエスト」を確認してください。',
        chatWith: 'チャットする',
        ...
        addFriendPlaceholder:
            '友達追加するメールアドレスを入力してください（例: admin1@example.com）',
    ...
    pricing: {
        ...
        menus: 'メニュー',
        users: 'ユーザー',
        dragDropBuilder: 'ドラッグ＆ドロップビルダー',
        customDomain: '独自ドメイン',
        basicSeo: '基本SEO',
        premiumSeo: '高度SEO',
        analyticsDashboard: '分析ダッシュボード',
        advancedAnalytics: '高度分析',
        month: '月',
        popular: '人気',
        currentPlan: '現在のプラン',
        upgrade: 'アップグレード',
