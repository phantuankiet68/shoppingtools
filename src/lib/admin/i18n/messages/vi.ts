const vi = {
    ...
    adminEmail: {
        templates: {
            ...
            reminder: {
                ...
                description:
                    'Dùng để nhắc người dùng về các thao tác chưa hoàn tất hoặc cập nhật quan trọng.',
                content:
    ...
    pageList: {
        ...
        createModal: {
            ...
            validation: {
                ...
                siteRequired: 'Vui lòng chọn website',
            },
    ...
    dashboard: {
        ...
        pagesUsed: 'Trang đã sử dụng',
        menusUsed: 'Menu đã sử dụng',
        categoriesUsed: 'Danh mục đã sử dụng',
        brandsUsed: 'Thương hiệu đã sử dụng',
    },
    scarler: {
        home: 'Nhà thông minh',
        loading: 'Đang tải...',
    ...
    brands: {
        ...
        empty: {
            ...
            description:
                'Hãy tạo thương hiệu đầu tiên ở khung bên trái hoặc thử thay đổi từ khóa tìm kiếm.',
        },
    ...
    products: {
        ...
        pleaseSelectAtLeastOneProductToDeactivate:
            'Vui lòng chọn ít nhất một sản phẩm để ngưng kích hoạt.',
        ...
        deactivateConfirmMultiple:
            'Ngưng kích hoạt {count} sản phẩm đã chọn? Hành động này không thể hoàn tác.',
    ...
    invoice: {
        ...
        thankYou:
            'Cảm ơn bạn đã mua hàng. Vui lòng hoàn tất thanh toán trong thời gian đã thỏa thuận.',
        invoiceQuestion:
        ...
        author: {
            ...
            steps: {
                ...
                generateToken: {
                    ...
                    warning:
                        'Hãy sử dụng Page Access Token thay vì User Access Token để đăng bài tự động.',
    ...
    emailProvider: {
        ...
        disconnectConfirmMessage:
            'Ngắt kết nối tài khoản Gmail "{email}"? Hành động này sẽ xóa liên kết OAuth.',
    ...
    adminChat: {
        ...
        noFriendsDesc:
            'Vào mục Thêm để gửi lời mời hoặc kiểm tra mục Lời mời để chấp nhận kết bạn.',
    ...
    pricing: {
        ...
        menus: 'Menu',
        users: 'Người dùng',
        dragDropBuilder: 'Trình kéo thả',
        customDomain: 'Tên miền riêng',
        basicSeo: 'SEO cơ bản',
        premiumSeo: 'SEO nâng cao',
