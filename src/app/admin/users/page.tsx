    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.footerNote}>
                <i className="bi bi-info-circle" /> Click a user row to expand the full editor like
                your screenshot.
            </div>
            {createOpen ? (
                <div
                            ...
                            <div className={styles.field}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setCreateForm((p) => ({
                                            ...p,
                                            profileRole: e.target.value as any,
                                        }))
                                    }
                                >
                            ...
                            <div className={styles.field}>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setCreateForm((p) => ({
                                            ...p,
                                            profileStatus: e.target.value as any,
                                        }))
                                    }
                                >
