        ...
        const item = await prisma.productVariant.update({
            ...
            data: {
                ...
                ...(dataIn.compareAtPrice !== undefined
                    ? {
                          compareAtPrice:
                              dataIn.compareAtPrice == null
                                  ? null
                                  : toDecimal(dataIn.compareAtPrice, '0'),
                      }
                    : {}),
                ...(dataIn.cost !== undefined
                    ? { cost: dataIn.cost == null ? null : toDecimal(dataIn.cost, '0') }
                    : {}),
                ...(dataIn.stockQty !== undefined
                    ? { stockQty: Math.max(0, Math.trunc(Number(dataIn.stockQty) || 0)) }
                    : {}),
                ...
                ...(dataIn.length !== undefined
                    ...
                    : {}),
                ...(dataIn.width !== undefined
                    ? { width: dataIn.width == null ? null : toDecimal(dataIn.width, '0') }
                    : {}),
