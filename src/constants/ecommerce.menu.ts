...
export const ECOMMERCE_INTERNAL_PAGES: InternalPage[] = [
    ...
    },
    {
        ...
        paths: {
            en: '/loyalty-program',
            vi: '/chuong-trinh-khach-hang-than-thiet',
            ja: '/ロイヤルティプログラム',
        },
...
export const LANDING_INTERNAL_PAGES: InternalPage[] = [
    ...
    },
    {
        ...
        labelKey: 'menus.landing.partners',
        icon: 'bi-diagram-3',
    },
    ...
    },
    {
        ...
        labelKey: 'menus.landing.solutions',
        icon: 'bi-lightbulb',
    },
    {
        id: 'pricing',
...

    {
        ...
        labelKey: 'menus.landing.products',
        icon: 'bi-box-seam',
    },
    {
        id: 'productDetail',
        paths: {
            en: '/product-detail',
            vi: '/chi-tiet-san-pham',
            ja: '/製品詳細',
        },
        labelKey: 'menus.landing.productDetail',
        icon: 'bi-box',
    },
    {
        id: 'portfolio',
...

    {
        ...
        labelKey: 'menus.landing.courses',
        icon: 'bi-mortarboard',
    },
    {
        id: 'courseDetail',
        paths: {
            en: '/course-detail',
            vi: '/chi-tiet-khoa-hoc',
            ja: '/コース詳細',
        },
        labelKey: 'menus.landing.courseDetail',
        icon: 'bi-book',
    },
    ...
    },
    {
        ...
        labelKey: 'menus.landing.newsletter',
        icon: 'bi-envelope-paper',
    },
    ...
    },
    {
        ...
        labelKey: 'menus.landing.forgotPassword',
        icon: 'bi-key',
    },

    {
        ...
        labelKey: 'menus.landing.getStarted',
        icon: 'bi-rocket',
    },
    {
        id: 'bookDemo',
        ...
        labelKey: 'menus.landing.bookDemo',
...
export const INTERNAL_PAGE_SETS: Record<SiteKind, InternalPage[]> = {
    ...
    booking: ECOMMERCE_INTERNAL_PAGES,
    news: ECOMMERCE_INTERNAL_PAGES,
    blog: ECOMMERCE_INTERNAL_PAGES,
    lms: ECOMMERCE_INTERNAL_PAGES,
};
