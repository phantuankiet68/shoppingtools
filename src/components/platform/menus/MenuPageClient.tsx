...
import { AREA_OPTIONS, MENU_AREA_OPTIONS } from '@/constants/platform/menus/menuConstants';
import type {
    AreaFilter,
    EditMenuFormState,
    MenuRecord,
...
import { useMenuActions } from '@/hooks/platform/menus/useMenuActions';
import { useMenus } from '@/hooks/platform/menus/useMenus';
import styles from '@/styles/platform/menus/menu.module.css';
import {
    createEditForm,
    formatDate,
    getInitials,
    getSiteLabel,
} from '@/utils/platform/menus/menuUtils';
...
export default function MenuPageClient() {
    ...
    const { savingMenuId, handleToggleAdminPermission, handleBulkToggleByArea } = useMenuActions({
        menus,
        setMenus,
        setSummary,
        fetchMenus,
                            ...
                            <div className={styles.toolbarLeft}>
                                ...
                                <div className={styles.areaFilter}>
                                    <div className={styles.areaFilterControl}>
                                        <i
                                            className={`bi bi-diagram-3 ${styles.areaFilterIcon}`}
                                            aria-hidden="true"
                                        />
                            ...
                            {loadingMenus ? (
                                ...
                                <div className={styles.stateRow}>
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Adjust the search keyword or filters to see more
                                            results.
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        {menus.map((menu) => {
                                            ...
                                            return (
                                                <div key={menu.id} className={styles.tableRow}>
                                                    ...
                                                    <div
                                                        className={`${styles.centerCell} ${styles.noWidth}`}
                                                    >
                                                        <span
                                                    ...
                                                    <div className={styles.centerCell}>
                                                        <span
                                                            className={`${styles.badge} ${
                                                                permissionEnabled
                                                                    ? styles.badgeSuccessSoft
                                                                    : styles.badgeDangerSoft
                                                            }`}
                                                        >
                                                            {permissionEnabled
                                                                ? 'Enabled'
                                    ...
                                    <div className={styles.pagination}>
                                        ...
                                        <div className={styles.paginationActions}>
                                            <button
                                                ...
                                                onClick={() => setPage(1)}
                                                disabled={
                                                    !pagination.hasPreviousPage || loadingMenus
                                                }
                                            >
                                                First
                                            </button>
                        ...
                        <div className={styles.sideCard}>
                            ...
                            <div className={styles.overviewList}>
                                <div className={styles.overviewItem}>
                                    ...
                                    <strong>
                                        {summary.total
                                            ? Math.round((summary.enabled / summary.total) * 100)
                                            : 0}
                                        %
                                    </strong>
                                </div>
                                <div className={styles.overviewItem}>
                                    ...
                                    <strong>
                                        {summary.total
                                            ? Math.round((summary.visible / summary.total) * 100)
                                            : 0}
                                        %
                                    </strong>
                                </div>
