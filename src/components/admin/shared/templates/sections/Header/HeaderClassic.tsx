...
import cls from "@/styles/templates/sections/Header/HeaderClassic.module.css";
  ...
  return (
    <header className={cls.header} ref={rootRef}>
        ...
        <div className={cls.container}>
          <div className={cls.navBarInner}>
            ...
            <div className={cls.navRight}>
              {preview ? (
                <a href="#" className={cls.dealBtn} onClick={onBlockClick}>
                  <i className="bi bi-lightning-charge-fill" />
                  <span>Today Deals</span>
                </a>
              ) : (
                <Link href={"/sale" as Route} className={cls.dealBtn}>
                  <i className="bi bi-lightning-charge-fill" />
                  <span>Today Deals</span>
                </Link>
              )}
      ...
      <div className={cls.mainBar}>
        <div className={cls.container}>
          <div className={cls.mainBarInner}>
            ...
            <div className={cls.searchCol}>
              ...
              >
                ...
                <div className={cls.searchMeta}>
                  <span>Trending:</span>
                  <button type="button">Skincare</button>
                  <button type="button">Lip Mask</button>
            ...
            <div className={cls.actionCol}>
              ...
              <div>
                ...
                >
                  ...
                  <span className={cls.accountText}>
                    <strong>{isLoggedIn ? displayName : authChecked ? "Sign in" : "Loading..."}</strong>
                    <small>{isLoggedIn ? displayRole : "Account & orders"}</small>
                  </span>
              ...
              {notificationOpen && (
                ...
                >
                  <div className={cls.dropdownHead}>
                    ...
                    <small>{unreadNotificationCount} unread updates</small>
                  </div>
              ...
              {cartOpen && (
                <div
                  ...
                  onClick={(e) => e.stopPropagation()}
                >
                  <div className={cls.dropdownHeadBetween}>
                    <div>
...
export const SHOP_HEADER_CLASSIC: RegItem = {
  kind: "HeaderClassic",
  label: "Header Classic",
  defaults: {
    brandHref: "/",
    brandName: "Tuan Kiet Store",
    brandSub: "Premium Beauty & Care",
  ...
  render: (props) => {
    ...
    return (
      <div aria-label="Shop Header Classic">
        <HeaderClassic
