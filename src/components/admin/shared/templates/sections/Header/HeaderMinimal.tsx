...
import cls from "@/styles/templates/sections/Header/HeaderMinimal.module.css";
...
const DEFAULT_CATEGORY_ITEMS: CategoryMenuItem[] = [
  ...
  { label: "Trang điểm", href: "/makeup", emoji: "💄" },
  ...
  { label: "Hàng mới", href: "/new-arrivals", emoji: "🆕" },
...
const DEFAULT_NOTIFICATIONS: ProductNotificationItem[] = [
  {
    id: "1",
    title: "Sản phẩm mới",
    message: "Laneige Lip Sleeping Mask vừa cập nhật hàng mới.",
    time: "20s",
  ...
  },
  {
    id: "2",
    title: "Flash sale",
    message: "Ưu đãi đến 40% cho nhóm sản phẩm skincare hôm nay.",
    time: "1h",
    href: "/sale",
    unread: true,
    thumbnail: "/assets/images/logo.jpg",
  ...
  },
  {
    id: "3",
    title: "Hàng đã về",
    message: "CeraVe Foaming Cleanser hiện đã có lại trong kho.",
    time: "3h",
      ...
      <div className={cls.container}>
        <div className={cls.topbar}>
          ...
          <div className={cls.actionsCol}>
            ...
            >
              ...
              {unreadNotificationCount > 0 ? <span className={cls.badge}>{unreadNotificationCount}</span> : null}
            </button>
            ...
            >
              ...
              {(badgeCart > 0 || cartItems.length > 0) && (
                <span className={cls.badge}>{badgeCart || cartItems.length}</span>
              )}
            </button>
            ...
            >
              ...
              <span className={cls.accountMeta}>
                ...
                <small>{isLoggedIn ? displayRole : "Tài khoản của bạn"}</small>
              </span>
            ...
            {notificationOpen && (
              ...
              >
                    ...
                    preview ? (
                      ...
                      >
                        ...
                        <span className={cls.notificationBody}>
                          <span className={cls.notificationRow}>
                ...
                <div className={cls.dropdownFoot}>
                  {preview ? (
                    <a href="#" className={cls.primaryLink} onClick={onBlockClick}>
                      Xem tất cả
                    </a>
                  ) : (
                    <Link
                      href={(notificationHref || "/notifications") as Route}
                      className={cls.primaryLink}
                      onClick={() => setNotificationOpen(false)}
                    >
                      Xem tất cả
                    </Link>
            ...
            {cartOpen && (
              <div className={cls.dropdown} role="dialog" aria-label="Cart panel" onClick={(e) => e.stopPropagation()}>
                ...
                <div className={cls.dropdownActions}>
                  {preview ? (
                    <a href="#" className={cls.ghostBtn} onClick={onBlockClick}>
                      Xem giỏ hàng
                    </a>
                  ) : (
                    <Link
            ...
            {isLoggedIn && accountOpen ? (
              <div className={cls.dropdown} role="menu" aria-label="Account menu" onClick={(e) => e.stopPropagation()}>
                ...
                <div className={cls.menuLinks}>
                  {preview ? (
                    <a href="#" className={cls.menuLink} onClick={onBlockClick}>
                      <i className="bi bi-person-circle" />
                      <span>Tài khoản</span>
                    </a>
                  ) : (
                    <Link href={"/account" as Route} className={cls.menuLink} onClick={() => setAccountOpen(false)}>
                      <i className="bi bi-person-circle" />
                      <span>Tài khoản</span>
                    </Link>
                  )}
                  ...
                  {preview ? (
                    ...
                    <Link href={"/wishlist" as Route} className={cls.menuLink} onClick={() => setAccountOpen(false)}>
                      <i className="bi bi-heart" />
                      <span>Yêu thích</span>
                    </Link>
                  )}
                ...
                <div className={cls.ordersBox}>
                  <div className={cls.ordersHead}>
        ...
        <div className={`${cls.navbar} ${mobileNavOpen ? cls.navbarOpen : ""}`}>
          <div className={cls.navLeft}>
            <div
              ref={categoryRef}
              className={`${cls.category} ${categoryOpen ? cls.categoryOpen : ""}`}
              onMouseEnter={() => {
            ...
            >
              ...
              >
                <span className={cls.categoryTriggerInner}>
                  <span className={cls.categoryIcon}>
                    <i className="bi bi-grid-3x3-gap" />
                  </span>
                  <span className={cls.categoryLabel}>Danh mục</span>
                </span>

                <span className={cls.categoryTriggerRight}>
                  ...
                  <div className={cls.categoryGrid}>
                    {categoryItems.map((cat, idx) => (
                      ...
                      >
                        ...
                        <span className={cls.categoryText}>{cat.label}</span>
                      </Link>
                    ))}
                  </div>
                </div>
            ...
            {shouldRenderNav &&
              items.map((it, idx) => {
                ...
                if (it.type !== "mega") {
                  return preview ? (
                    <a key={idx} className={cls.navItem} href="#" onClick={onBlockClick}>
                      {it.icon ? (
                        <span className={cls.navItemIcon}>
                          <i className={iconCls} />
                        </span>
                      ) : null}
                      <span className={cls.navItemLabel}>{it.label}</span>
                    </a>
                  ) : (
                ...
                return (
                  <div
                    key={idx}
                    className={`${cls.navItemWrap} ${isOpen ? cls.navItemWrapOpen : ""}`}
                    onMouseEnter={() => {
                  ...
                  >
                    ...
                    >
                      ...
                      <span className={cls.navCaretWrap}>
            ...
            {!shouldRenderNav && menuLoaded ? (
              preview ? (
                <a href="#" className={cls.navItem} onClick={onBlockClick}>
                  <span className={cls.navItemLabel}>Home</span>
                </a>
              ) : (
          ...
          <div className={cls.navRight}>
            {preview ? (
              <a href="#" className={cls.highlightLink} onClick={onBlockClick}>
                <i className="bi bi-lightning-charge" />
                <span>Today's Deals</span>
              </a>
            ) : (
              <Link href={"/sale" as Route} className={cls.highlightLink}>
                <i className="bi bi-lightning-charge" />
                <span>Today's Deals</span>
              </Link>
            )}
...
export const SHOP_HEADER_MINIMAL: RegItem = {
  kind: "HeaderMinimal",
  ...
  render: (props) => {
    ...
    return (
      <div aria-label="Shop Header Minimal">
        <HeaderMinimal
