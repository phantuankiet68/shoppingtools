...
import cls from "@/styles/templates/sections/Header/HeaderDashboard.module.css";
...
const DEFAULT_CATEGORY_ITEMS: CategoryMenuItem[] = [
  { label: "Flash Sale", href: "/flash-sale", emoji: "⚡" },
  { label: "Skincare", href: "/skincare", emoji: "🧴" },
  { label: "Makeup", href: "/makeup", emoji: "💄" },
  { label: "Hair Care", href: "/hair-care", emoji: "🫧" },
  { label: "Body Care", href: "/body-care", emoji: "🛁" },
  { label: "Fragrance", href: "/fragrance", emoji: "🌸" },
  { label: "Mom & Baby", href: "/mom-baby", emoji: "🍼" },
  { label: "Supplements", href: "/health", emoji: "💊" },
  { label: "Beauty Tools", href: "/beauty-tools", emoji: "✨" },
...
const DEFAULT_NOTIFICATIONS: ProductNotificationItem[] = [
  {
    ...
    message: "Up to 50% off selected skincare products today.",
    time: "5m",
    href: "/flash-sale",
    unread: true,
  ...
  },
  {
    id: "2",
    title: "Back in stock",
    message: "Laneige Lip Sleeping Mask is now available again.",
    time: "12m",
  ...
  },
  {
    id: "3",
    title: "Order shipped",
    message: "Your recent order has been handed to the carrier.",
    time: "1h",
    href: "/account/orders",
    unread: false,
    thumbnail: "/assets/images/logo.jpg",
  ...
  },
  {
    ...
    message: "You received a member voucher for your next checkout.",
    time: "Today",
    ...
    <header className={cls.header} ref={rootRef}>
      <div className={cls.container}>
        <div className={cls.main}>
          ...
          <div className={cls.workspaceColumn}>
            <div
            ...
            >
              ...
              {badgeStoreLocator > 0 ? <span className={cls.workspaceBadge}>{badgeStoreLocator}</span> : null}

              <i className={`bi bi-chevron-down ${cls.workspaceCaret}`} />
                        ...
                        <div className={cls.megaMenuInner}>
                          {it.columns.map((col, cIdx) => (
                            <div className={cls.megaColumn} key={cIdx}>
                              <div className={cls.megaColumnTitle}>{col.title}</div>
          ...
          <div className={cls.searchColumn}>
            <form
          ...
          <div className={cls.actionColumn}>
            ...
            >
              <span className={cls.iconActionWrap}>
            ...
            >
              ...
              <span className={cls.accountMeta}>
                ...
                <small>{isLoggedIn ? displayRole : "Customer account"}</small>
              </span>
              ...
              >
                <div className={cls.dropdownHead}>
                  <div>
                    ...
                    <small>{unreadNotificationCount} unread items</small>
                  </div>
                </div>
        ...
        <div className={`${cls.mobilePanel} ${mobileNavOpen ? cls.mobilePanelOpen : ""}`}>
          <div className={cls.mobilePanelInner}>
            ...
            <div className={cls.mobileWorkspaceGrid}>
              {categoryItems.map((cat, idx) =>
                preview ? (
                  <a key={idx} href="#" className={cls.mobileWorkspaceCard} onClick={onBlockClick}>
                    <span>{cat.emoji || "•"}</span>
                    <b>{cat.label}</b>
                  </a>
                ) : (
                  <Link key={idx} href={(cat.href || "/") as Route} className={cls.mobileWorkspaceCard}>
                    <span>{cat.emoji || "•"}</span>
                    <b>{cat.label}</b>
                  </Link>
                ),
...
export const SHOP_HEADER_DASHBOARD: RegItem = {
  kind: "HeaderDashboard",
  ...
  render: (props) => {
    ...
    return (
      <div aria-label="Shop Header Dashboard">
        <HeaderDashboard
