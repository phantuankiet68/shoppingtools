...
import type { HeaderAuroraPinkProps } from "@/components/admin/shared/templates/ShopTemplate/Ui/header/HeaderAuroraPink";
    ...
    <>
      ...
      <Section title="Logo">
        <LabeledRow label="Icon class (Bootstrap Icons)">
          <TextInput
            value={props.logoIconClass ?? "bi bi-heart"}
        ...
        <LabeledRow label="Tiêu đề">
          <TextInput
            ...
            onChange={(v) => updateActive({ logoText: v })}
            placeholder="Aurora Pink"
          />
        </LabeledRow>
        ...
        <LabeledRow label="Mô tả ngắn">
          <TextInput
            ...
            placeholder="Fashion & Lifestyle 2025"
          />
        </LabeledRow>
      ...
      <Section title="Menu &amp; API">
        ...
        <LabeledRow label="Site ID (nếu có)">
          <TextInput
            ...
            placeholder="site id từ DB (optional)"
          />
        </LabeledRow>
      </Section>
      ...
      <Section title="Thanh tìm kiếm">
        <LabeledRow label="Placeholder search">
          <TextInput
            ...
            placeholder="Tìm váy, áo, phụ kiện pastel..."
          />
        </LabeledRow>

        <LabeledRow label="Hiển thị nút danh mục (category)">
          <Checkbox
            checked={props.showCategoryDropdown ?? true}
        ...
        <LabeledRow label="Label nút danh mục">
          <TextInput
            ...
            onChange={(v) => updateActive({ categoryLabel: v })}
      ...
      <Section title="Actions bên phải">
        <LabeledRow label="Hiển thị icon Yêu thích">
          <Checkbox
            checked={props.showWishlist ?? true}
        ...
        <LabeledRow label="Text nút Đăng nhập">
          <TextInput
            value={props.authLabel ?? ""}
            onChange={(v) => updateActive({ authLabel: v })}
      ...
      <Section title="Khác">
        ...
        <LabeledRow label="Block key khi click trong preview">
          <TextInput
            value={props.onPreviewBlockClickKey ?? "header-aurora-pink"}
            onChange={(v) => updateActive({ onPreviewBlockClickKey: v })}
            placeholder="header-aurora-pink"
          />
        </LabeledRow>
      </Section>
    </>
