...
type TopbarBlueDarkEditorProps = {
  props: TopbarBlueDarkProps;
  updateActive: (patch: Partial<TopbarBlueDarkProps>) => void;
};

const TopbarBlueDarkEditor: React.FC<TopbarBlueDarkEditorProps> = ({ props, updateActive }) => {
...
export default TopbarBlueDarkEditor;
