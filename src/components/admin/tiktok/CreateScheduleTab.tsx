    ...
    const handleAutomationFill = async () => {
        try {
            ...
            setForm({
                ...
                hashtags:
                    '#tiktokshop #viralproducts #ledlamp #roomdecor #gamingsetup #fyp #tiktokviral',
                seoKeywords:
                    'smart led lamp, gaming setup lamp, tiktok viral product, bedroom led light',
                publishAt,
                        ...
                        <div className={styles.phone}>
                            ...
                            <div className={styles.previewOverlay}>
                                ...
                                <div className={styles.previewText}>
                                    ...
                                    {form.hashtags && (
                                        <div className={styles.previewTags}>{form.hashtags}</div>
                                    )}
                                </div>
                            </div>
                        </div>
