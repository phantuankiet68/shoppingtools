        ...
        <section className={styles.sectionInline}>
          <div className={styles.searchWrap}>
            ...
            <input
              ...
              placeholder={loading ? "Loading..." : "Search integrations..."}
              value={query}
                  ...
                  <div className={styles.logs}>
                    <div className={styles.logsHeader}>
                      ...
                      <button
                        ...
                        type="button"
                        title="Refresh logs"
                        onClick={() => active && loadLogs(active.id)}
                        disabled={busy}
                      >
                        <i className="bi bi-arrow-repeat" />
                      </button>
              ...
              <div className={styles.form}>
                ...
                <div className={styles.inputWrap}>
                  ...
                  <input
                    ...
                    placeholder="e.g. stripe, postmark, openai"
                  />
                </div>
                ...
                <div className={styles.inputWrap}>
                  ...
                  <select
                    ...
                    onChange={(e) => setCreateForm((s) => ({ ...s, category: e.target.value as any }))}
                  >
