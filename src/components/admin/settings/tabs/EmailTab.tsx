...
> = {
    resend: {
        ...
        tone: 'Resend is ideal for modern transactional emails, easy to configure, and quick to deploy.',
    },
    ...
    sendgrid: {
        ...
        tone: 'SendGrid is suitable for large systems that need high email volume and strong management capabilities.',
    },
    ...
    mailgun: {
        ...
        tone: 'Mailgun is strong for custom domains, routing, and email workflows that require flexible configuration.',
    },
    ...
    smtp: {
        ...
        tone: 'SMTP is suitable when you use your own mail infrastructure or want to connect through your existing email provider.',
    },
};
...
export default function EmailTab() {
            ...
            try {
                ...
                if (json.data) {
                    ...
                    setForm((prev) => ({
                        ...
                        provider:
                            (newData.provider as SystemCredentialForm['provider']) ?? prev.provider,
                        ...
                        siteId: newData.siteId ?? sites?.[0]?.id ?? prev.siteId,
                    }));
                } else if (sites?.[0]?.id) {
                    setForm((prev) => ({
                        ...prev,
    ...
    const handleChange = (key: keyof SystemCredentialForm, value: string | boolean) => {
        setSaveMessage('');
                ...
                <div className={styles.heroContent}>
                    <div className={styles.heroLeft}>
                        ...
                        <p className={styles.heroDesc}>
                            Configure the email provider, sender identity, and application scope.
                        </p>
                        ...
                        <label className={styles.field}>
                            ...
                            <div className={styles.inputWrap}>
                                ...
                                <input
                                    ...
                                    readOnly
                                    disabled
                                    placeholder="sites_cuid_or_uuid"
                                />
                            </div>
                            <small>Auto-filled from the current sites.</small>
                        </label>
