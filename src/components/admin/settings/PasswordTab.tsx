...
export default function ChangePassword() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        if (!canSubmit) {
            setStatus({
                type: 'error',
                message: 'Vui lòng nhập đầy đủ thông tin và đáp ứng chính sách mật khẩu.',
            });
            return;
        }
                    ...
                    <div className={styles.header}>
                        <div className={styles.headerTopbar}>
                            ...
                            <div className={styles.headerContent}>
                                <span className={styles.badge}>Account Security</span>
                                <h1 className={styles.title}>Update Your Password</h1>
                            </div>
                        </div>
                        <p className={styles.description}>
                            We recommend using at least 8 characters.
                        </p>
                    </div>
                        ...
                        <div className={styles.kv}>
                            ...
                            <div className={styles.v}>
                                <span
                                    className={cx(
                                        styles.pill,
                                        account.twoFA ? styles.pillOk : styles.pillWarn,
                                    )}
                                >
                    ...
                    <div className={styles.panel}>
                        ...
                        <div className={styles.strength}>
                            ...
                            <div className={styles.smallNote}>
                                Tip: Use a long passphrase + special chars. Avoid reusing old
                                passwords.
                            </div>
                        </div>
                    </div>
                ...
                <section className={styles.right}>
                    <form className={styles.form} onSubmit={handleSubmit}>
                        ...
                        <label className={styles.checkboxRow}>
                            <input
                                type="checkbox"
                                checked={form.signOutAll}
                                onChange={update('signOutAll')}
                            />
                        ...
                        <label className={styles.checkboxRow}>
                            ...
                            />
                            <span>
                                I understand this action is irreversible and I agree to change my
                                password.
                            </span>
                        </label>
                        ...
                        <div className={styles.footerNote}>
                            Having trouble? Contact your administrator or reset via email
                            verification.
                        </div>
                    </form>
                </section>
...
function Rule({ ok, text }: { ok: boolean; text: string }) {
    return (
        <li className={styles.rule}>
            <i
                className={`bi ${ok ? 'bi-check2' : 'bi-circle'} ${ok ? styles.ruleOk : styles.ruleOff}`}
            />
...
function PasswordInput({
    ...
    return (
        <div className={styles.inputWrap}>
            ...
            <i
                className={`bi ${ok ? 'bi-check-lg' : 'bi-x-lg'} ${ok ? styles.okIcon : styles.badIcon}`}
            />
        </div>
    );
}
