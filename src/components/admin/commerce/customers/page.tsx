...
import type {
    ...
    CustomerStatus,
    CustomerStore,
} from '@/store/commerce/customers/customer.store';
...
export default function CustomersPage() {
    ...
    const stats = useMemo(() => {
        ...
        const active =
            statsServer?.active ??
            customers.filter(
                (customer) => customer.status === 'ACTIVE' || customer.status === 'VIP',
            ).length;
    ...
    const addCustomFormTag = useCallback(() => {
        ...
        setFormTags((previousTags) => {
            const alreadyExists = previousTags.some(
    ...
    const executeDelete = useCallback(async () => {
        ...
        try {
            if (selectedCount > 0) {
                ...
                modal.success(
                    'Success',
                    `Deactivated ${selectedCount} selected customer(s) successfully.`,
                );
                return;
            }
    ...
    const handleDelete = useCallback(() => {
        ...
        if (selectedCount > 0) {
            modal.confirmDelete(
                ...
                `Deactivate ${selectedCount} selected customer(s)?`,
                () => {
                    void executeDelete();
                },
            );
        ...
        if (activeCustomer) {
            modal.confirmDelete(
                'Delete customer?',
                `Delete “${activeCustomer.name}”? This action cannot be undone.`,
                () => {
                    void executeDelete();
                },
            );
    ...
    const leftFormShortcutHint =
        leftFormMode === 'EDIT'
            ? 'F5: focus form · F10: update customer'
            : 'F5: focus form · F10: create customer';
                        ...
                        <label className={styles.label}>
                            ...
                            <div className={styles.selectWrap}>
                                ...
                                <select
                                    ...
                                    value={formStatus}
                                    onChange={(event) =>
                                        setFormStatus(event.target.value as CustomerStatus)
                                    }
                                >
                    ...
                    <div className={styles.section} style={{ marginTop: 18 }}>
                        ...
                        <div className={styles.sectionBody}>
                                ...
                                <div className={styles.tagPickRow} style={{ marginBottom: 12 }}>
                                    {allTags.map((tag) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <i
                                                    className={`bi ${active ? 'bi-check2' : 'bi-plus'}`}
                                                />
                                                {tag}
                                            </button>
                                        );
                            ...
                            <div className={styles.tagRow}>
                                {formTags.length === 0 ? (
                                    <span className={styles.muted}>No tags selected</span>
                                ) : null}
                                {formTags.map((tag) => (
                                    <button
                                        key={tag}
                        ...
                        <div className={styles.filters}>
                            <div className={styles.selectWrap}>
                                ...
                                <select
                                    ...
                                    value={statusFilter}
                                    onChange={(event) =>
                                        setStatusFilter(event.target.value as CustomerFilterStatus)
                                    }
                                >
                            ...
                            <div className={styles.tableHeadRight}>
                                <button
                                    ...
                                    onClick={() =>
                                        modal.success(
                                            'Coming soon',
                                            'Columns builder will be added later.',
                                        )
                                    }
                                >
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        modal.success(
                                            'Coming soon',
                                            'Saved views will be added later.',
                                        )
                                    }
                                >
                                        ...
                                        <th className={styles.thCheck}>
                                            <input
                                                ...
                                                checked={
                                                    ...
                                                    pagedCustomers.every((customer) =>
                                                        Boolean(selected[customer.id]),
                                                    )
                                                }
                                                onChange={(event) =>
                                        ...
                                        pagedCustomers.map((customer) => {
                                            ...
                                            return (
                                                <tr
                                                    key={customer.id}
                                                    className={styles.tr}
                                                    onDoubleClick={() => void openDrawer(customer)}
                                                >
                                                    <td
                                                    ...
                                                    <td
                                                        className={styles.tdCustomer}
                                                        onClick={() => void openDrawer(customer)}
                                                    >
                                                    ...
                                                    <td>
                                                        <span
                                                            className={`${styles.badge} ${styles[`badge_${customer.status}`]}`}
                                                        >
