...
export default function AdminMessagesClient() {
    ...
    const isAblyConnected = (client: Ably.Realtime | null) =>
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const res = await fetch(API_ROUTES.ADMIN_CHAT.MESSAGES(activeChatId), {
                    cache: 'no-store',
                });
                const json = await res.json();
                if (!res.ok) {
                        ...
                        [activeChatId]: curr.map((m) =>
                            m.id === tempId
                                ? {
                                      ...
                                      name: displayName({
                                          email: real.sender?.email,
                                          profile: real.sender?.profile ?? null,
                                      }),
                                  }
                                : m,
                        ),
                ...
                <div className={styles.sidebarHeader}>
                    <div className={styles.sidebarTitle}>
                        ...
                        <div className={styles.sidebarTitleText}>
                            ...
                            <div className={styles.sidebarTitleSub}>
                                {' '}
                                {t('adminChat.teamInbox')}{' '}
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className={styles.emptyNotice}>
                                        ...
                                        <div className={styles.emptyText}>
                                            <div className={styles.emptyTitle}>
                                                {t('adminChat.noFriendsYet')}
                                            </div>
                                            <div className={styles.emptyDesc}>
                                                {t('adminChat.noFriendsDesc')}
                                            </div>
                                        </div>
                                    </div>
                                ) : (
                                    ...
                                    <div className={styles.requestHeadLeft}>
                                        ...
                                        <div className={styles.requestHeadText}>
                                            <div className={styles.requestTitle}>
                                                {t('adminChat.incomingRequests')}
                                            </div>
                                            <div className={styles.requestSubtitle}>
                                                {t('adminChat.incomingRequestsDesc')}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <>
                                <div className={styles.addFriendBox}>
                                    <div className={styles.addFriendField}>
                                        <label className={styles.addFriendLabel}>
                                            {t('adminChat.addFriendByEmail')}
                                        </label>

                                        <div className={styles.addFriendInputWrap}>
                                            <i
                                                className={`bi bi-envelope ${styles.addFriendInputIcon}`}
                                            />
                                            <input
                                    ...
                                    >
                                        <i
                                            className={`bi ${addBusy ? 'bi-arrow-repeat' : 'bi-send'} ${addBusy ? styles.spin : ''}`}
                                        />
                                        <span className={styles.sendText}>
                                            {addBusy
                                                ? t('adminChat.sending')
                                                : t('adminChat.sendFriendRequest')}
                                        </span>
                                    </button>
                ...
                <header className={styles.header}>
                    ...
                    <div className={styles.headerLeft}>
                        ...
                        <div className={styles.headerTitleBox}>
                            <div className={styles.headerKicker}>
                                ...
                                <span className={styles.kickerStrong}>
                                    {t('adminChat.header.messages')}
                                </span>
                            </div>
                            ...
                            <div className={styles.headerTitleRow}>
                                ...
                                <span className={styles.membersPill}>
                                    ...
                                    <span>
                                        {activeChat?.membersCount ?? 0}{' '}
                                        {t('adminChat.header.members')}
                                    </span>
                                </span>
                            </div>
                        </div>
                    ...
                    <div className={styles.headerActions}>
                        ...
                        <button
                            className={styles.iconBtn}
                            type="button"
                            title={t('adminChat.header.addMember')}
                        >
                            <i className="bi bi-person-plus" />
                        </button>
                ...
                <section className={styles.thread} ref={threadRef}>
                    ...
                    {loadingMsgs ? (
                        ...
                        <div className={styles.msgState}>
                            ...
                            <span> {t('adminChat.thread.noMessages')} </span>
                        </div>
                    ) : (
                        msgs.map((m) => (
                            <div
                                ...
                                <div className={styles.msgBubble}>
                                    ...
                                    <div className={styles.msgActions}>
                                        <button
                                            ...
                                            type="button"
                                            title={t('adminChat.thread.react')}
                                        >
                                        ...
                                        <button
                                            className={styles.msgIconBtn}
                                            type="button"
                                            title={t('adminChat.thread.reply')}
                                        >
                            ...
                            <div className={styles.divRow}>
                                <div className={styles.hintRow}>
                                    <span className={styles.hintKey}>
                                        {' '}
                                        {t('adminChat.composer.enter')}{' '}
                                    </span>
                                    <span className={styles.hintText}>
                                        {' '}
                                        {t('adminChat.composer.toSend')}{' '}
                                    </span>
                                </div>
                                <div className={styles.tools}>
                                    <div className={styles.toolGroup}>
                                        ...
                                        <button
                                            className={styles.toolBtn}
                                            type="button"
                                            title={t('adminChat.composer.mention')}
                                        >
                                            <i className="bi bi-at" />
                                        </button>
                                        <button
                                    ...
                                    >
                                        ...
                                        <span className={styles.sendText}>
                                            {sending
                                                ? t('adminChat.composer.sending')
                                                : t('adminChat.composer.send')}
                                        </span>
                                    </button>
                                </div>
                            </div>
