                ...
                <div className={styles.grid}>
                    ...
                    <section className={styles.left}>
                        ...
                        <Field label="Backup Email">
                            ...
                            />
                            {errors.backupEmail ? (
                                <div className={styles.errorText}>{errors.backupEmail}</div>
                            ) : null}
                        </Field>
                            ...
                            <div className={styles.securityGrid}>
                                <div className={styles.securityItem}>
                                    ...
                                    <button
                                        ...
                                        className={cx(
                                            styles.pill,
                                            profile.twoFA ? styles.pillOn : styles.pillOff,
                                        )}
                                        onClick={toggle2FA}
                                    >
                            ...
                            <Field label="Date of Birth">
                                <div className={styles.dobRow}>
                                    ...
                                    <select
                                        ...
                                        onChange={onChange('dobYear')}
                                    >
                                        {Array.from({ length: 80 }, (_, i) => String(2026 - i)).map(
                                            (y) => (
                            ...
                            <div className={styles.payments}>
                                {payments.map((p) => (
                                    <div
                                        ...
                                        className={cx(
                                            styles.payCard,
                                            p.isDefault && styles.payCardDefault,
                                        )}
                                    >
                                        <div className={styles.payTop}>
                                            <div className={styles.brand}>
                                                <span
                                                    className={cx(
                                                        styles.brandPill,
                                                        p.brand === 'mastercard' && styles.brandMC,
                                                    )}
                                                >
