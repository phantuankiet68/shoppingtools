...
-- CreateEnum
CREATE TYPE "MenuItemType" AS ENUM ('PAGE', 'CUSTOM_URL');

-- CreateEnum
CREATE TYPE "MenuSetKey" AS ENUM ('home', 'dashboard');
...
CREATE TABLE "menu_items" (
    ...
    "set_key" "MenuSetKey" NOT NULL DEFAULT 'home',
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "deleted_at" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "menu_items_site_id_idx" ON "menu_items"("site_id");

-- CreateIndex
CREATE INDEX "menu_items_site_id_set_key_idx" ON "menu_items"("site_id", "set_key");
...
-- CreateIndex
CREATE INDEX "menu_items_site_id_set_key_sort_order_idx" ON "menu_items"("site_id", "set_key", "sort_order");

-- CreateIndex
CREATE INDEX "menu_items_site_id_visible_idx" ON "menu_items"("site_id", "visible");
